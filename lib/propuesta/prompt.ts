...
export function construirSystem(): string[] {
  ...
  const formato = [
    ...
    "- `equipo` — 1 a 3 integrantes. `rol` hasta 60, `dedicacionHorasSemana` entero de 1 a",
    "  45. Lo habitual es la arquitecta líder sola; sumá un rol de apoyo solo si el alcance",
    "  lo pide.",
    "- `inversion` — `servicio` (un identificador del catálogo), `posicion` y",
    "  `justificacion` de 40 a 400 caracteres.",
