...
export function construirSystem(): string[] {
  ...
  const formato = [
    ...
    "- `procesosManuales` — entre 1 y 4 entradas: `proceso` (hasta 120) e `impactoOperativo`",
    "  (hasta 160). Nombralos y ordenalos por peso. No pongas horas ni plata: eso lo calcula el",
    "  código.",
    "- `riesgos` — entre 2 y 4 entradas: `titulo` (hasta 80), `severidad` (`alta`, `media` o",
    "  `baja`) e `impactoNegocio` (hasta 240: qué pasa si ocurre).",
    ...
    "- `preguntasDiscovery` — entre 3 y 8 preguntas, hasta 180 caracteres cada una.",
